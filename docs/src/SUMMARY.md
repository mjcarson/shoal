...
- [Resolved Issues](appendix/resolved-issues.md)
  ...
  - [113. glommio's `DmaFile::open_at` unwrapped `statfs` after a successful open](appendix/resolved/glommio-open-statfs.md)
  ...
  - [155, the remainder. A restore whose group failed could not be finished](appendix/resolved/restore-retry.md)
  ...
  - [169. A member the placement does not name refused every client query](appendix/resolved/unplaced-member-forwards.md)
