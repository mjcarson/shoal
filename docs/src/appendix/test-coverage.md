...
~~**1,265 tests**~~ ~~**1,289 tests**~~ ~~**1,320 tests**~~ ~~**1,342 tests**~~ ~~**1,361 tests**~~ ~~**1,382 tests**~~ ~~**1,398 tests**~~ ~~**1,414 tests**~~ ~~**1,432 tests**~~ ~~**1,449 tests**~~ ~~**1,467 tests**~~ ~~**1,475 tests**~~ ~~**1,484 tests**~~ ~~**1,492 tests**~~ ~~**1,493 tests**~~ **1,494 tests**, four ignored, plus ~~**13**~~ **14** behind
...
| `shoalctl` unit | 3 | up 1 with the distributed chapter's rewrite: the `initialize` verb's order, preview and request; new with [F50](../features/cluster-operations.md): the cluster tab's model and its actions |
