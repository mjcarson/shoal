...
`cargo test --workspace` passes: ~~**1,187 tests**~~ ~~**1,198 tests**~~ **1,238 tests**, four
ignored, plus **13** behind `--features stage-profile` that a default run does not reach.
...
now.~~ ~~It sums to 1,198 now~~ It sums to **1,238** now, against a `--workspace` run — which is
