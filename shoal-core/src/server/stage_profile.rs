...
// The clock both peers read. It lives in the protocol crate so a client can hold a stamp without
// linking an engine, and is re-exported here so the rest of the profiler names it unchanged.
pub use shoal_proto::stamps::{Offset, Stamp};
